...
open class DefaultApi : ApiClient {
    ...
    constructor(baseUrl: String = ApiClient.BASE_URL, httpClient: io.ktor.client.HttpClient) : super(
        baseUrl,
        httpClient,
    )
     ...
     * @return void
     */
    open suspend fun getCharacterImageById(
     ...
     * @return void
     */
    open suspend fun getPersonImageById(
        personId: kotlin.Int,
        type: kotlin.String,
    ): HttpResponse<Unit> {
        val localVariableAuthNames = listOf<String>("OptionalHTTPBearer")
     ...
     */
    @Suppress("UNCHECKED_CAST")
    open suspend fun getRelatedCharactersByPersonId(
        personId: kotlin.Int,
    ): HttpResponse<kotlin.collections.List<PersonCharacter>> {
        val localVariableAuthNames = listOf<String>()
     ...
     */
    @Suppress("UNCHECKED_CAST")
    open suspend fun getRelatedCharactersBySubjectId(
        subjectId: kotlin.Int,
    ): HttpResponse<kotlin.collections.List<RelatedCharacter>> {
        val localVariableAuthNames = listOf<String>("OptionalHTTPBearer")
     ...
     */
    @Suppress("UNCHECKED_CAST")
    open suspend fun getRelatedPersonsByCharacterId(
        characterId: kotlin.Int,
    ): HttpResponse<kotlin.collections.List<CharacterPerson>> {
        val localVariableAuthNames = listOf<String>()
     ...
     */
    @Suppress("UNCHECKED_CAST")
    open suspend fun getRelatedPersonsBySubjectId(
        subjectId: kotlin.Int,
    ): HttpResponse<kotlin.collections.List<RelatedPerson>> {
        val localVariableAuthNames = listOf<String>("OptionalHTTPBearer")
     ...
     */
    @Suppress("UNCHECKED_CAST")
    open suspend fun getRelatedSubjectsByCharacterId(
        characterId: kotlin.Int,
    ): HttpResponse<kotlin.collections.List<V0RelatedSubject>> {
        val localVariableAuthNames = listOf<String>()
     ...
     */
    @Suppress("UNCHECKED_CAST")
    open suspend fun getRelatedSubjectsByPersonId(
        personId: kotlin.Int,
    ): HttpResponse<kotlin.collections.List<V0RelatedSubject>> {
        val localVariableAuthNames = listOf<String>()
     ...
     */
    @Suppress("UNCHECKED_CAST")
    open suspend fun getRelatedSubjectsBySubjectId(
        subjectId: kotlin.Int,
    ): HttpResponse<kotlin.collections.List<V0SubjectRelation>> {
        val localVariableAuthNames = listOf<String>("OptionalHTTPBearer")
     ...
     * @return void
     */
    open suspend fun getSubjectImageById(
        subjectId: kotlin.Int,
        type: kotlin.String,
    ): HttpResponse<Unit> {
        val localVariableAuthNames = listOf<String>("OptionalHTTPBearer")
     ...
     */
    @Suppress("UNCHECKED_CAST")
    open suspend fun getSubjects(
        type: SubjectType,
        cat: SubjectCategory?,
        series: kotlin.Boolean?,
     ...
     */
    @Suppress("UNCHECKED_CAST")
    open suspend fun getUserCharacterCollection(
        username: kotlin.String,
        characterId: kotlin.Int,
    ): HttpResponse<UserCharacterCollection> {
        val localVariableAuthNames = listOf<String>()
     ...
     */
    @Suppress("UNCHECKED_CAST")
    open suspend fun getUserPersonCollection(
        username: kotlin.String,
        personId: kotlin.Int,
    ): HttpResponse<UserPersonCollection> {
        val localVariableAuthNames = listOf<String>()
    ...
    open suspend fun getUserSubjectEpisodeCollection(
        ...
        limit: kotlin.Int?,
        episodeType: EpType?,
    ): HttpResponse<GetUserSubjectEpisodeCollection200Response> {
        val localVariableAuthNames = listOf<String>("HTTPBearer")
    ...
    open suspend fun patchUserSubjectEpisodeCollection(
        subjectId: kotlin.Int,
        patchUserSubjectEpisodeCollectionRequest: PatchUserSubjectEpisodeCollectionRequest?,
    ): HttpResponse<Unit> {
        val localVariableAuthNames = listOf<String>("HTTPBearer")
     ...
     */
    @Suppress("UNCHECKED_CAST")
    open suspend fun searchPersons(
        limit: kotlin.Int?,
        offset: kotlin.Int?,
        searchPersonsRequest: SearchPersonsRequest?,
    ): HttpResponse<PagedPerson> {
        val localVariableAuthNames = listOf<String>()
