...
class PersonDetailTest : ShouldSpec() {
    init {
        ...
        //val modelInstance = PersonDetail()
        ...
        // to test the property `lastModified` - currently it's latest user comment time, it will be replaced by wiki modified date in the future
